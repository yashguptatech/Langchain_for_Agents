...
# NVIDIA Vision LLM (Supports multimodal images + structured output)
...
def describe_product_image(image_path: str) -> str:
    ...
    message = HumanMessage(content=[
        ...
        },
        {
            ...
            "text": (
                ...
                "Return ONLY a valid JSON object (no markdown formatting, no backticks) with these fields:\n"
    ...
    # Strip any potential markdown fences so the agent gets clean parseable text
